...
#define SQL_CREATE_TABLE [NSString stringWithFormat:@"CREATE TABLE IF NOT EXISTS %@ (%@ TEXT,%@ TEXT,%@ TEXT,%@ BLOB,%@ BLOB,%@ REAL,%@ REAL);", TABLE_NAME, COLUMN_NAME_REQUEST_ID, COLUMN_NAME_METHOD, COLUMN_NAME_URL, COLUMN_NAME_HEADERS, COLUMN_NAME_PAYLOAD, COLUMN_NAME_TIMESTAMP, COLUMN_NAME_EXPIRY]
